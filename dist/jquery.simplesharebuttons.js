...
(function ($) {
	...
	function Plugin(element, options) {
		...
		function attachEvents() {
			...
			function fetchTwitterCount(url) {
				/*
			...
			function fetchLinkedInCount(url) {
				/*
			...
			function fetchGooglePlusCount(url) {
				$.ajax({
					url: options.GooglePlusAPIProvider + '?url=' + url,
					async: true,
					dataType: 'text',
				}).done(function (response) {
